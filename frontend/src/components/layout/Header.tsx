...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background/80 px-4 backdrop-blur sm:px-6">
      <form onSubmit={onSubmit} className="relative w-full max-w-md" data-testid="search-form">
      ...
      <div className="ml-auto text-sm text-muted-foreground">Operations console</div>
    </header>
  );
}
